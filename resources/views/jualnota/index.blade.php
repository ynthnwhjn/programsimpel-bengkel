...
<div class="box" ng-controller="PageController">
    <div class="box-header with-border">
        ...
        <div class="btn-group">
            <a href="{{ route('jualnota.create') }}" class="btn btn-default">Create</a>
        </div>
    </div>
    <div class="box-body">
    ...
    (function () {
        ...
        function PageController($scope, $uibModal, $http, $validation, DTOptionsBuilder, DTColumnBuilder) {
            ...
            $scope.dtColumns = [
                ...
                DTColumnBuilder.newColumn('customer.nama').withTitle('Customer'),
                DTColumnBuilder.newColumn(null).withTitle('<i class="fa fa-bars"></i>')
                    .withOption('width', 90)
                    .withOption('class', 'dt-center')
                    .renderWith(function (data, type, row, meta) {
                        return '<a href="'+ route('jualnota.edit', row) +'">Edit</a>';
                    }),
            ];
        }
    })();
